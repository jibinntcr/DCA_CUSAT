                    ...
                    <div class="row g-3">
                        ...
                        ?>
                                ...
                                <div class="col-lg-3 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                                    <a class="position-relative d-block overflow-hidden" href="gallery-images.php?id=<?php echo   $result->id ?>" target="_blank">
                                        <img class="img-fluid" src="admin/pages/uploads/<?php echo $result->thumbnail ?>" alt="">
