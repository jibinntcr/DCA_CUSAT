...
<head>
    <meta charset="utf-8">
    <title>Recognition | DCA CUSAT</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Recognition</h1>
                    ...
                    ?>
                            ...
                            <div class="col-md-6">
                                <div class="resume-wrap ftco-animate">
                                    <span class="date"><?php echo $result->name ?></span>
                                    <h6><?php echo $result->designation ?></h6>

                                    </br>
                                    </br>
                                    <p><?php echo $result->recognition ?></p>
                                </div>
                            </div>
                    <?php }
                    }
