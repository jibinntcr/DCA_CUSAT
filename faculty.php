                        ...
                        <div class="col-lg-3 col-md-6 mb-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item bg-light">
                                ...
                                <div class="text-center p-4">
                                    <h5> <a href="faculty-profile.php?id=<?php echo   $result->id ?>" target="_blank" class="mb-0"><?php echo $result->name ?></br><?php echo $result->thumbname ?></a></h5>
