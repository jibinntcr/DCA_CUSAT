...
<head>
    <meta charset="utf-8">
    <title>Contact us | DCA CUSAT</title>
...
<body>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">Department of Computer Applications
                                </br>Cochin University of Science and Technology</br>
                                Cochin-682022</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <div><a class="mb-0" href="tel:+91484-2577602">0484-2577602</a></br>
                                <a class="mb-0" href="tel:+914842576253">0484-2576253</a>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h5 class="text-primary"></h5>
                            <p> <a class="mb-0" href="mailto:dcahod@cusat.ac.in"> dcahod@cusat.ac.in </a></p>
                        </div>
                    </div>
                </div>
    ...
    <?php
    $sql = "SELECT * from dcaoth";
    $query = $dbh->prepare($sql);
    $query->execute();
    $userArr = $query->fetchAll(PDO::FETCH_OBJ);
    if ($query->rowCount() > 0) {
        echo ($userArr[0]->AuthKey);
    }
    ?>
