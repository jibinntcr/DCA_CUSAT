...
?>
    ...
    <head>
        ...
        <title>Edit Patent | DCA Admin</title>
        <!-- plugins:css -->
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="EditMember2" name="EditMember2" value="<?php echo htmlentities($userArr[0]->member2); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Year">Member 1</label>
                                                <input type="text" class="form-control" id="EditMember3" name="EditMember3" value="<?php echo htmlentities($userArr[0]->member3); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Year">Member 1</label>
                                                <input type="text" class="form-control" id="EditMember4" name="EditMember4" value="<?php echo htmlentities($userArr[0]->member4); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="Year">Member 1</label>
                                                <input type="text" class="form-control" id="EditMember5" name="EditMember5" value="<?php echo htmlentities($userArr[0]->member5); ?>">
                                            </div>
                                            <div class="form-group">
