...
<body>
    ...
    <footer class="footer">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022. Premium <a href="https://infiniio.co.in/" target="_blank">Infinio Technology Solutions</a> All rights reserved.</span>
